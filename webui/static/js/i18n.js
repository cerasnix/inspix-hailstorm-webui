window.I18n = (() => {
  const strings = {
    en: {
      ...
      "search.clear": "Clear",
      "search.clearFilters": "Clear filters only",
      ...
      "search.matchModeLabel": "Chip match",
      "search.matchModeAny": "Any in same group",
      "search.matchModeAll": "All in same group",
      "search.matchModeAnyShort": "Any",
      "search.matchModeAllShort": "All",
      "search.activeFilters": "{{count}} active filters · mode {{mode}}",
      "search.activeFilterRemove": "Remove this filter",
      ...
      "search.entriesFiltered": "{{count}} entries (from {{total}})",
      ...
      "search.filterVideoSource": "Mapped source",
      "search.filterSearchPlaceholder": "Filter within group...",
      "search.filterCollapse": "Fold",
      "search.filterExpand": "Expand",
      "search.filterShowMore": "+{{count}}",
      "search.filterShowLess": "Less",
      "search.filterNoMatch": "No matching chips.",
      "search.videoSource.advDigest": "Story digest",
      "search.videoSource.tutorial": "Tutorial",
      "search.videoSource.memberIntro": "Member intro",
      "search.videoSource.fesLive": "Fes live movie",
      "search.videoSource.styleMovie": "Style movie",
      "search.videoSource.memberVoice": "Member voice",
      "search.videoSource.styleVoice": "Style voice",
      "search.videoSource.cardGetMovie": "Card home movie",
      ...
      "view.prefabAssemblyDuplicateBySizeShown":
    ...
    zh: {
      ...
      "search.order": "顺序",
      "search.perPage": "每页数量",
      "search.matchModeLabel": "同组多选逻辑",
      "search.matchModeAny": "同组命中任一项",
      "search.matchModeAll": "同组必须全部命中",
      "search.matchModeAnyShort": "任一",
      "search.matchModeAllShort": "全部",
      "search.activeFilters": "已启用 {{count}} 项筛选 · 模式 {{mode}}",
      "search.activeFilterRemove": "移除该筛选",
      ...
      "search.entriesFiltered": "{{count}} 条结果（总计 {{total}}）",
      ...
      "search.filterVideoSource": "来源映射",
      "search.filterSearchPlaceholder": "在当前分组内搜索…",
      "search.filterCollapse": "收起",
      "search.filterExpand": "展开",
      "search.filterShowMore": "更多 {{count}}",
      "search.filterShowLess": "收起更多",
      "search.filterNoMatch": "当前分组没有匹配项。",
      "search.videoSource.advDigest": "剧情速览",
      "search.videoSource.tutorial": "教程视频",
      "search.videoSource.memberIntro": "角色介绍",
      "search.videoSource.fesLive": "Fes 演出视频",
      "search.videoSource.styleMovie": "卡面剧情视频",
      "search.videoSource.memberVoice": "角色语音",
      "search.videoSource.styleVoice": "卡面语音",
      "search.videoSource.cardGetMovie": "卡面主页视频",
      "search.filterNamingPrefix": "命名前缀",
      "search.filterCostumeSeries": "服装系列",
      "search.filterCodeCharacter": "编号角色",
      "search.filterVariant": "变体尾码",
    ...
    ja: {
      ...
      "search.clear": "クリア",
      "search.clearFilters": "フィルターのみクリア",
      ...
      "search.matchModeLabel": "同一グループの一致条件",
      "search.matchModeAny": "同一グループでいずれか一致",
      "search.matchModeAll": "同一グループで全て一致",
      "search.matchModeAnyShort": "いずれか",
      "search.matchModeAllShort": "すべて",
      "search.activeFilters": "有効なフィルター {{count}} 件 ・ モード {{mode}}",
      "search.activeFilterRemove": "このフィルターを解除",
      "search.diffFrom": "比較元",
      "search.diffTo": "比較先",
      ...
      "search.entriesFiltered": "{{count}} 件（全 {{total}} 件）",
      ...
      "search.filterVideoSource": "ソース分類",
      "search.filterSearchPlaceholder": "このグループ内を検索…",
      "search.filterCollapse": "折りたたむ",
      "search.filterExpand": "展開",
      "search.filterShowMore": "さらに {{count}} 件",
      "search.filterShowLess": "折りたたむ",
      "search.filterNoMatch": "一致する項目はありません。",
      "search.videoSource.advDigest": "ダイジェスト",
      "search.videoSource.tutorial": "チュートリアル",
      "search.videoSource.memberIntro": "メンバー紹介",
      "search.videoSource.fesLive": "フェスライブ動画",
      "search.videoSource.styleMovie": "スタイルムービー",
      "search.videoSource.memberVoice": "メンバーボイス",
      "search.videoSource.styleVoice": "スタイルボイス",
      "search.videoSource.cardGetMovie": "カードホーム動画",
      "search.filterNamingPrefix": "命名プレフィックス",
      "search.filterCostumeSeries": "衣装シリーズ",
      "search.filterCodeCharacter": "コードキャラクター",
      "search.filterVariant": "バリアント",
